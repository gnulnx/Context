...
def test_json_failures_and_no_changes(args, tmp_path, monkeypatch):
    ...
    for _ in range(2):
        ...
        assert all(c["summary"] in ("Not implemented", "Prerequisites unavailable", "Data installation unavailable", "Background service unavailable", "Codex MCP unavailable", "Codex skill unavailable", "Codex hooks unavailable", "Embedding model unavailable", "Session inventory unavailable", "Historical import incomplete")
